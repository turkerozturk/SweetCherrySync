...
@Repository
public interface FromImageRepository extends JpaRepository<Image, CombinedId> {

    List<Image> findByIdNodeId(Integer nodeId);

    @Query("SELECT g.id FROM Image g")
    List<CombinedId> findAllIds();

    /* gerek yok, gerekirse uncomment edilip denenir.
